...
multipass launch --name $MASTER_NAME --cpus 1 --memory 2G --disk 20G
multipass launch --name $W1_NAME --cpus 4 --memory 12G --disk 50G
multipass launch --name $W2_NAME --cpus 2 --memory 8G --disk 40G
